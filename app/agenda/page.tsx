...
export default function AgendaPage() {
  ...
  const [showFormat, setShowFormat] = useState("Voz e Violão");
                ...
                return (
                  ...
                  >
                    ...
                    {eventosDia.map((evento) => {
                      const qtdColaboradores = colaboradoresDoEvento(evento.id).length;
                      ...
                      return (
                        ...
                        >
                          ...
                          {evento.show_format}
                          <br />
                          {evento.event_time} • {evento.show_duration}
                          <br />
                          {evento.location}
                          <br />
                          <small>Equipe: {qtdColaboradores}</small>
                        </div>
                      );
                    })}
                  </div>
          ...
          <aside style={panelStyle}>
            ...
            <form onSubmit={salvarEvento} style={{ display: "grid", gap: "12px" }}>
              ...
              <select style={inputStyle} value={showFormat} onChange={(e) => setShowFormat(e.target.value)}>
                <option>Voz e Violão</option>
                <option>Acústico</option>
                <option>All Vibes</option>
                <option>A Rodinha do Ribeiro</option>
                <option>Vih Ribeiro - Show Principal</option>
              </select>
